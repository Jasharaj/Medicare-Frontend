          ...
          <div className='md:col-span-2'>
            ...
            <div className='mt-[50px] border-b border-solid border-[#0066ff34]'>
              <button
                ...
                className={`${tab === 'about' && "border-b border-solid border-primaryColor"} py-2 px-5 mr-5 leading-7 text-headingColor font-semibold`}>About</button>
              <button
                onClick={() => setTab('feedback')}
                className={`${tab === 'feedback' && "border-b border-solid border-primaryColor"} py-2 px-5 mr-5 leading-7 text-headingColor font-semibold`}>Feedback</button>
            </div>
