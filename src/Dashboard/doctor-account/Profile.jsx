...
const Profile = ({ doctorData }) => {
    ...
    const addQualification = (e) => {
        e.preventDefault()
        addItem('qualifications', { startingDate: "", endingDate: "", degree: "PHD", university: "Dhaka Medical College" })
    }
        ...
        <div>
            ...
            <form>
                ...
                <div className='mb-5'>
                    ...
                    <button onClick={addQualification} className='bg-[#000] py-2 px-5 text-white h-fit cursor-pointer'>
                        Add Qualification
                    </button>
                </div>
                <div className='mb-5'>
                    ...
                    <button onClick={addExperience} className='bg-[#000] py-2 px-5 text-white h-fit cursor-pointer'>
                        Add Experience
                    </button>
                </div>
                <div className='mb-5'>
                    ...
                    <button onClick={addTimeSlot} className='bg-[#000] py-2 px-5 text-white h-fit cursor-pointer'>
                        Add TimeSlot
                    </button>
                </div>
                <div className="mb-5">
